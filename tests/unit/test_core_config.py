"""Unit tests for src.core.config — env var loading and validation."""

from src.core.config import REQUIRED_ENV_VARS, load_env, validate_env
...
def test_load_env_is_callable():
    # Smoke test — load_env is a no-op when .env is absent or vars already set
    load_env()
